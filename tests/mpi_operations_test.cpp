...
TEST(OperationsTest, builtin_operations_on_unsupported_type) {
  ...
  EXPECT_FALSE(
    (kamping::internal::mpi_operation_traits<kamping::ops::max<>, std::complex<double>>::is_builtin)
  );
  EXPECT_FALSE((kamping::internal::mpi_operation_traits<kamping::ops::min<>, DummyType>::is_builtin)
  );
  EXPECT_FALSE(
    (kamping::internal::mpi_operation_traits<kamping::ops::min<>, std::complex<double>>::is_builtin)
  );
