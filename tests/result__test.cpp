...
void test_recv_buffer_in_MPIResult() {
    ...
    MPIResult_          mpi_result{std::make_tuple(std::move(recv_buffer))};
...
void test_recv_counts_in_MPIResult() {
    ...
    std::iota(ptr, ptr + 10, 0);
    MPIResult_          mpi_result{std::make_tuple(std::move(recv_counts))};
...
void test_recv_count_in_MPIResult() {
    ...
    MPIResult_ mpi_result{std::make_tuple(std::move(recv_count_wrapper))};
...
void test_recv_displs_in_MPIResult() {
    ...
    std::iota(ptr, ptr + 10, 0);
    MPIResult_          mpi_result{std::make_tuple(std::move(recv_displs))};
...
void test_send_counts_in_MPIResult() {
    ...
    std::iota(ptr, ptr + 10, 0);
    MPIResult_          mpi_result{std::make_tuple(std::move(send_counts))};
...
void test_send_count_in_MPIResult() {
    ...
    MPIResult_ mpi_result{std::make_tuple(std::move(send_count_wrapper))};
...
void test_send_displs_in_MPIResult() {
    ...
    std::iota(ptr, ptr + 10, 0);
    MPIResult_          mpi_result{std::make_tuple(std::move(send_displs))};
...
TEST(MpiResult_Test, has_extract_v_basics) {
    static_assert(
...
TEST(MpiResultTest, removed_extract_functions) {
    ...
    constexpr BufferType btype = BufferType::out_buffer;
    {
        ...
        kamping::MPIResult_ mpi_result_sanity_check{std::make_tuple(
...

    {
        ...
        kamping::MPIResult_ mpi_result{std::make_tuple()};
...

    {
        ...
        auto                                   result_recv_counts = make_mpi_result_<OutParameters>(
...

    {
        ...
        auto                                   result_recv_displs = make_mpi_result_<OutParameters>(
...

    {
        ...
        auto                                   result_send_displs = make_mpi_result_<OutParameters>(
