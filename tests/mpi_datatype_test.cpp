...
TEST(MpiDataTypeTest, mpi_datatype_basics) {
    ...
    EXPECT_THAT(
      possible_mpi_datatypes<short>(), Contains(mpi_datatype<short>())
    );
    EXPECT_THAT(
    ...
    EXPECT_THAT(
      possible_mpi_datatypes<float>(), Contains(mpi_datatype<float>())
    );
    EXPECT_THAT(
...
TEST(MpiDataTypeTest, mpi_datatype_enum) {
    ...
    EXPECT_THAT(
      unscopedEnumInt_types, Contains(mpi_datatype<unscopedEnumInt>())
    );
