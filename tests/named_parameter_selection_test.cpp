...
TEST(NamedParameterTest, select_parameter_type_basics) {
    ...
    testing::Argument<ParameterType::send_counts> arg2{2};
    {
        const auto& selected_arg =
            select_parameter_type<ParameterType::send_buf>(arg0, arg1, arg2);
        EXPECT_EQ(selected_arg._i, 0);
    }
    {
        const auto& selected_arg =
            select_parameter_type<ParameterType::recv_buf>(arg0, arg1, arg2);
...
TEST(NamedParameterTest, has_parameter_type_basics_compile_time) {
    ...
    static_assert(has_parameter_type<
                  ParameterType::send_buf, decltype(arg0), decltype(arg1),
                  decltype(arg2)>());
    static_assert(has_parameter_type<
                  ParameterType::recv_buf, decltype(arg0), decltype(arg1),
                  decltype(arg2)>());
    static_assert(has_parameter_type<
                  ParameterType::send_counts, decltype(arg0), decltype(arg1),
                  decltype(arg2)>());
    static_assert(!has_parameter_type<
                  ParameterType::root, decltype(arg0), decltype(arg1),
                  decltype(arg2)>());
}
...
TEST(NamedParameterTest, default_parameters) {
    ...
    {
        auto&& selected_arg = select_parameter_type_or_default<
            ParameterType::root, DefaultArgument>(
            std::tuple(42), arg0, arg1, arg2
        );
        static_assert(std::is_same_v<
                      decltype(selected_arg), DefaultArgument&&>);
...
TEST(NamedParameterTest, select_parameter_type_duplicates) {
    ...
    testing::Argument<ParameterType::send_buf>    arg3{3};
    {
        ...
        const auto& selected_arg =
            select_parameter_type<ParameterType::send_buf>(
                arg0, arg1, arg2, arg3
            );
        EXPECT_EQ(selected_arg._i, 0);
    }
...
// Test that has_parameter_type can be invoked if the function is called with
// zero arguments
