...
#include "named_parameters_test_helpers.hpp"
...
TEST(ParameterFactoriesTest, send_type_basic) {
    auto send_type          = kamping::send_type(MPI_INT);
    using ExpectedValueType = MPI_Datatype;
    testing::test_single_element_buffer<ExpectedValueType>(
        send_type,
...
TEST(ParameterFactoriesTest, recv_type_basic) {
    auto recv_type          = kamping::recv_type(MPI_INT);
    using ExpectedValueType = MPI_Datatype;
    testing::test_single_element_buffer<ExpectedValueType>(
        recv_type,
...
TEST(ParameterFactoriesTest, send_type_out_basic) {
    auto send_type            = kamping::send_type_out();
    using ExpectedValueType   = MPI_Datatype;
    bool should_be_modifiable = true;
    testing::test_single_element_buffer<ExpectedValueType>(
        send_type,
        ParameterType::send_type,
        internal::BufferType::out_buffer,
        MPI_Datatype{},
        should_be_modifiable
    );
}

TEST(ParameterFactoriesTest, recv_type_out_basic) {
