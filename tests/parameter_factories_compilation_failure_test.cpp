...
int main(int /*argc*/, char** /*argv*/) {
    ...
    // vector<bool> is not allowed, also if a custom allocator is used, because the STL may still do
    // optimizations
    ...
    auto buf = internal::make_data_buffer<type, internal::BufferModifiability::modifiable>(
