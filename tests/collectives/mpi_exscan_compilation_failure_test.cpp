...
int main(int /*argc*/, char** /*argv*/) {
    ...
    comm.exscan(send_buf(input), send_recv_type(MPI_INT), op(kamping::ops::plus<>{}), recv_buf<no_resize>(recv_buffer));
    ...
    int const        result = comm.exscan_single(send_buf(input), op(kamping::ops::plus<>{}));
#else
