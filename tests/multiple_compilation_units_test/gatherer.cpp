...
/// @file
/// @brief The source file for the second compilation unit of a test that checks if compiling and
/// running works correctly when linking two compilation units that both use KaMPIng
