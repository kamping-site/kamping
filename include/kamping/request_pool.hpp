...
public:
    ...
    /// according to its \ref BufferResizePolicy, even not all requests have completed yet. This is because MPI does not
    /// allow retrieving statuses after a test succeeded.
    template <typename StatusesParamObjectType = decltype(kamping::statuses(ignore<>))>
