...
private:
    RecvBuf
      _recv_buffer; ///< Buffer object containing the received elements. May be
                    ///< empty if the received elements have been written into
    ...
    RecvCounts
      _recv_counts; ///< Buffer object containing the receive counts. May be
                    ...
                    ///< storage owned by the caller of KaMPIng.
    RecvCount
      _recv_count; ///< Object containing the receive count. May be empty if the
                   ///< operation does not yield a receive count.
    RecvDispls
