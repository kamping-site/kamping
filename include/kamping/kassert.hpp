...
#define THROWING_KASSERT(...)            \
    KAMPING_KASSERT_HPP_VARARG_HELPER_2( \
...
[[maybe_unused]] std::string inline build_what(
    std::string const& expression, SourceLocation const where, std::string const& message) {
