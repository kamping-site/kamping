...
///
/// This wraps \c MPI_Reduce. The operation combines the elements in the input buffer provided via
/// \c kamping::send_buf() and returns the combined value on the root rank. The following parameters
/// are required:
...
/// - \ref kamping::root() the root rank. If not set, the default root process of the communicator
/// will be used.
