...
///
/// This wraps \c MPI_Allreduce. The operation combines the elements in the input buffer provided
/// via \c kamping::send_buf() and returns the combined value on all ranks. The following parameters
/// are required:
