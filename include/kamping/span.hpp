...
///
/// Since KaMPIng needs to be C++17 compatible and \c std::span is part of
/// C++20, we need our own implementation of the above-described functionality.
...
public:
    ...
    using difference_type =
        std::ptrdiff_t; ///< The type used for the difference between two
