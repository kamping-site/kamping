...
auto kamping::Communicator<DefaultContainerType, Plugins...>::isend(Args... args) const {
    ...
    if constexpr (std::is_same_v<send_mode, internal::standard_mode_t>) {
        ...
        this->_mpi_ret_code_hook(err, "MPI_Isend");
        ...
        this->_mpi_ret_code_hook(err, "MPI_Ibsend");
        ...
        this->_mpi_ret_code_hook(err, "MPI_Issend");
        ...
        this->_mpi_ret_code_hook(err, "MPI_Irsend");
    }
