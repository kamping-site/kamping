...
* Use informative names for templated types. "T1" etc. is only allowed for really, rally general code. Template names are in CamelCase (like classes), e.g. `GeneratorFunction`.
